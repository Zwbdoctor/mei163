...
# Scrapy settings for mei project
#
...
SPIDER_MODULES = ['mei.spiders']
NEWSPIDER_MODULE = 'mei.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'mei (+http://www.yourdomain.com)'
USER_AGENTS = [
...
#SPIDER_MIDDLEWARES = {
#    'mei.middlewares.MeiSpiderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
    'mei.pipelines.RedisUrlPipeline': 250,
    # 'mei.pipelines.MakeUrlPipeline': 300,
    'mei.pipelines.MeiPipeline': 350,
}
